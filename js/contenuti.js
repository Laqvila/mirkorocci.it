...
const FEATURED = [
  ...
  { img:"assets/inno-talks-2/sala.jpg", tag:NTAG.social,
    ...
    d:{ it:"Oltre 40 persone all'Irish Pub di via Verdi per il secondo aperitivo dell'innovazione che ho ideato e curo per Innovalley. Qui trovate la diretta integrale, le foto e il resoconto, dal keynote del prof. Michele Flammini alle imprese del Tecnopolo d'Abruzzo West Aquila e Accyourate Group.", en:"Over 40 people at the Irish Pub in via Verdi for the second innovation aperitif I created and curate for Innovalley. Here you can find the full live stream, the photos and the report, from Prof. Michele Flammini's keynote to the Tecnopolo d'Abruzzo companies West Aquila and Accyourate Group.", es:"Más de 40 personas en el Irish Pub de via Verdi para el segundo aperitivo de la innovación que ideé y curo para Innovalley. Aquí están la retransmisión completa, las fotos y el resumen, desde la ponencia del prof. Michele Flammini hasta las empresas del Tecnopolo d'Abruzzo West Aquila y Accyourate Group.", fr:"Plus de 40 personnes à l'Irish Pub de via Verdi pour le deuxième apéritif de l'innovation que j'ai conçu et que je cure pour Innovalley. Voici le direct intégral, les photos et le compte rendu, de la keynote du prof. Michele Flammini aux entreprises du Tecnopolo d'Abruzzo West Aquila et Accyourate Group." },
