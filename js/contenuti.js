...
const NEWS = [
  ...
  { date:{ it:"Set 2026", en:"Sep 2026", es:"Sep 2026", fr:"Sept. 2026" }, tag:NTAG.conf, url:"",
...
const FEATURED = [
  ...
  { img:"assets/press/innotalk2-laquilablog.jpg", tag:NTAG.social,
    date:{ it:"24 settembre 2026", en:"24 September 2026", es:"24 de septiembre de 2026", fr:"24 septembre 2026" },
    t:{ it:"Inno Talk #2: «Dalla ricerca al prodotto», giovedì 24 settembre", en:"Inno Talk #2: 'From research to product', Thursday 24 September", es:"Inno Talk #2: «De la investigación al producto», jueves 24 de septiembre", fr:"Inno Talk #2 : « De la recherche au produit », jeudi 24 septembre" },
    d:{ it:"Torna all'Aquila l'aperitivo dell'innovazione che ho ideato e curo per Innovalley. Apro e conduco la serata all'Irish Pub di via Verdi, alle 18:30, con il keynote del prof. Michele Flammini del Gran Sasso Science Institute e le imprese del Tecnopolo d'Abruzzo, Accyourate Group e West Aquila.", en:"The innovation aperitif I created and curate for Innovalley returns to L'Aquila. I open and host the evening at the Irish Pub in via Verdi, at 18:30, with a keynote by Prof. Michele Flammini of the Gran Sasso Science Institute and the companies of Tecnopolo d'Abruzzo, Accyourate Group and West Aquila.", es:"Vuelve a L'Aquila el aperitivo de la innovación que ideé y curo para Innovalley. Abro y conduzco la velada en el Irish Pub de via Verdi, a las 18:30, con la ponencia del prof. Michele Flammini del Gran Sasso Science Institute y las empresas del Tecnopolo d'Abruzzo, Accyourate Group y West Aquila.", fr:"L'apéritif de l'innovation que j'ai conçu et que je cure pour Innovalley revient à L'Aquila. J'ouvre et anime la soirée à l'Irish Pub de via Verdi, à 18h30, avec la keynote du prof. Michele Flammini du Gran Sasso Science Institute et les entreprises du Tecnopolo d'Abruzzo, Accyourate Group et West Aquila." },
    url:"#inno99" },
